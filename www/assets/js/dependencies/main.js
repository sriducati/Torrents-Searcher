...
if(Torrentz[i].url.indexOf('.com') === -1 && Torrentz[i].url.indexOf('.net') === -1 && Torrentz[i].url.indexOf('.org') === -1)
{

console.log("done");                  
var Torrent_Link = Torrentz[i].url;
                  all_torrents += '<li class="list-group-item clearfix"><div class="row"><div class="col-sm-9"><a href="links.php?link='+Torrent_Link.substring(1)+'">'+Torrentz[i].title+'</a> </div><div class="col-sm-3"><div class="col-sm-4 right_width">'+Torrentz[i].size+'</div><div class="col-sm-3 right_width">'+Torrentz[i].old+'</div><div class="col-sm-3 right_width">'+Torrentz[i].seeds+'</div><div class="col-sm-2 right_width">'+Torrentz[i].Leechers+'</div></div></div></li>'
